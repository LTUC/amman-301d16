...
function displayPics(){
  ...
  // PUT YOUR RESPONSE IN THIS COMMENT because the scope of the let variable is a local scope, so the variable rando scope is inside {} of displayPics() function only
  console.log(viewed);
