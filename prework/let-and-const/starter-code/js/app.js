...
function displayPics(){
  ...
  // PUT YOUR RESPONSE IN THIS COMMENT: (rando's scope is within the while loop and the error is because rando is used outside its scope and it decleared using let which makes rando usable and defined within its scope only, unlike using var which make rando usable and defined all over the code.)
  console.log(viewed);
