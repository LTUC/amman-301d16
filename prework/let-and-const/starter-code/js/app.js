...
// the rando variable is decleared by let , but this variable is localy scoped for the function , and the console of rando was globaly decleared ,so we have to get red of the console that gives error and the code will run.
