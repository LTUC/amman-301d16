...
function displayPics(){
  ...
  // PUT YOUR RESPONSE IN THIS COMMENT: because we defined rando using let which blocked scoped varibale and we can use the variable inside the block in which we defined the variable rando which is "while loop" not outside the block.
  console.log(viewed);
