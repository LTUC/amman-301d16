...
function displayPics(){
  ...
  // TODO: In a sentence or two, explain why the previous line of code threw an error when we changed the const variable declaration from `const  to `const`.
  // PUT YOUR RESPONSE IN THIS COMMENT :because  the variable rando converted to block scoped {} so it will not be globaly defined .
  console.log(viewed);
